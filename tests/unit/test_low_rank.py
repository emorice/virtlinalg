...
def test_low_rank_product() -> None:
    ...
    vec1 = vnp.wrap_vectors(np.array([1, 2]))
    vec2 = vnp.wrap_vectors(np.array([3, 4]))
    vec3 = vnp.wrap_vectors(np.array([5, 6]))
...
def test_low_rank_update() -> None:
    ...
    vec2 = vnp.wrap_vectors(np.array([7, 8]))
    mat2 = vnp.wrap(np.array([[9]]))
    vec3 = vnp.wrap_vectors(np.array([10, 11]))
...
def test_optional_center() -> None:
    ...
    left = vnp.wrap_vectors(np.array([5, 6]))
    right_t = vnp.wrap_vectors(np.array([7, 8]))
...
def test_inverse_low_rank_update() -> None:
    ...
    left = vnp.wrap_vectors(np.array([7, 8]))
    center = vnp.wrap(np.array([[9]]))
    right_t = vnp.wrap_vectors(np.array([10, 11]))
